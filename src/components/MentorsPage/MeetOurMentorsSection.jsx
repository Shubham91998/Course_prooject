      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div style={{ opacity: 1, transform: 'none' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ opacity: 1, willChange: 'auto' }}>
            ...
            <div className="bg-white shadow-md rounded-3xl p-6 cursor-pointer flex flex-col items-center" tabIndex="0" style={{ willChange: 'auto', transform: 'none' }}>
